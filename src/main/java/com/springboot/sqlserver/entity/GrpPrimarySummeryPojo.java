...
@Entity
@Table(name = "grp_Primary")
public class GrpPrimarySummeryPojo {
	@Id
	@Column(name = "grpno")
	private int grpno;
	...
	private String nO_oF_dEFAULT_aCCOUNTS,tOTAL_rESPONSES,nO_oF_cLOSED_aCCOUNTS,nO_oF_aCTIVE_aCCOUNTS,nO_oF_oTHER_mFIS,nO_oF_oWN_mFIS;
	...
	public String toString() {
		return "GrpPrimarySummeryPojo [grpno=" + grpno + ", refId=" + refId + ", timestamp=" + timestamp
